        ...
        <div class="row g-3 mb-4 animate-in">
            ...
            <div class="col-md-3">
                <div class="kpi-card kpi-red h-100">
                    ...
                    <div class="kpi-value" style="color: var(--danger);"><?php echo e(number_format($totalIS + $totalCEL + $totalExportTax, 1)); ?><span class="kpi-unit">M$</span></div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-modern mb-0">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $cashflows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $yearTotal = $cf->royalties + $cf->state_share + $cf->petrosen_share + $cf->income_tax + $cf->cel + $cf->export_tax; ?>
                            <tr>
    ...
    <script>
        ...
        new Chart(document.getElementById('stateBreakdownChart'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($totalRoyalties); ?>, <?php echo e($totalStateShare); ?>, <?php echo e($totalPetrosenShare); ?>, <?php echo e($totalIS); ?>, <?php echo e($totalCEL); ?>, <?php echo e($totalExportTax); ?>],
