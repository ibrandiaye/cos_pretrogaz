    ...
    <body>
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-brand">
                <a href="{{ route('projects.index') }}" style="display: flex; align-items: center; gap: 0.75rem; text-decoration: none; flex: 1; overflow: hidden;">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('projects.index') }}" class="sidebar-link {{ request()->routeIs('projects.index') ? 'active' : '' }}" data-tooltip="Mes Projets">
                    <i class="bi bi-grid-1x2-fill"></i>
                    <span class="link-text">Mes Projets</span>
                </a>
                <a href="{{ route('projects.create') }}" class="sidebar-link {{ request()->routeIs('projects.create') ? 'active' : '' }}" data-tooltip="Nouveau Projet">
                    <i class="bi bi-plus-circle"></i>
                    <span class="link-text">Nouveau Projet</span>
                </a>
                <a href="{{ route('petroleum-codes.index') }}" class="sidebar-link {{ request()->routeIs('petroleum-codes.*') ? 'active' : '' }}" data-tooltip="Codes Petroliers">
                ...
                @if(isset($project))
                <a href="{{ route('projects.show', $project) }}" class="sidebar-link {{ request()->routeIs('projects.show') ? 'active' : '' }}" data-tooltip="Parametres">
                    <i class="bi bi-sliders"></i>
                    <span class="link-text">Parametres</span>
                </a>
                <a href="{{ route('dashboards.show', $project) }}" class="sidebar-link {{ request()->routeIs('dashboards.show') ? 'active' : '' }}" data-tooltip="Analytics">
                    <i class="bi bi-bar-chart-line-fill"></i>
                    <span class="link-text">Analytics</span>
                </a>
                <a href="{{ route('dashboards.state', $project) }}" class="sidebar-link {{ request()->routeIs('dashboards.state') ? 'active' : '' }}" data-tooltip="Vue Etatique">
